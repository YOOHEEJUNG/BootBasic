...
//		System.out.println(type);
		...
		//브라우저별로 경로가 포함되어서 올라오는 경우가 있어서 간단한 처리
...
//		System.out.println(origin);
		...
		try {
			File save = new File(savename); //저장 경로
...
//			System.out.println(origin);
		...
		//비동기 업로드 - 넘어오는 데이터는 form형식이기 때문에 vo 또는 requestParam으로 받으면 된다
		@PostMapping("/upload_ok4")
		@ResponseBody //요청이 들어온 곳으로 return 값으로 다시 돌아간다
